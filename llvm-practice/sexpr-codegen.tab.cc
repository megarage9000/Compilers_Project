...
#ifndef YY_YY_SEXPR_CODEGEN_TAB_H_INCLUDED
# define YY_YY_SEXPR_CODEGEN_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
union YYSTYPE
{
#line 90 "sexpr-codegen.y"

  class ExprAST *ast;
  int number;

#line 220 "sexpr-codegen.tab.c"
...
#endif /* !YY_YY_SEXPR_CODEGEN_TAB_H_INCLUDED  */
...
#line 99 "sexpr-codegen.y"
	     ...
	     Value *RetVal = (yyvsp[0].ast)->Codegen();
	     delete (yyvsp[0].ast); // get rid of abstract syntax tree
...
#line 1397 "sexpr-codegen.tab.c"
    break;

  case 3:
#line 118 "sexpr-codegen.y"
            { 
	      (yyval.ast) = new BinaryExprAST('+', (yyvsp[-2].ast), new NumberExprAST((yyvsp[0].number)));
	    }
#line 1405 "sexpr-codegen.tab.c"
    break;

  case 4:
#line 122 "sexpr-codegen.y"
            { 
	      (yyval.ast) = new BinaryExprAST('-', (yyvsp[-2].ast), new NumberExprAST((yyvsp[0].number))); 
	    }
#line 1413 "sexpr-codegen.tab.c"
    break;

  case 5:
#line 126 "sexpr-codegen.y"
            { 
	      (yyval.ast) = new NumberExprAST((yyvsp[0].number)); 
	    }
#line 1421 "sexpr-codegen.tab.c"
    break;


#line 1425 "sexpr-codegen.tab.c"
